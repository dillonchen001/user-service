...
// QueryUser queries the user edge of a AuthProvider.
func (c *AuthProviderClient) QueryUser(_m *AuthProvider) *UserQuery {
...
func (c *UserClient) QueryAuthProviders(_m *User) *AuthProviderQuery {
...
type (
	hooks struct {
		AuthProvider, User []ent.Hook
	}
	inters struct {
		AuthProvider, User []ent.Interceptor
	}
)
