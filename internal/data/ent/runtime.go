...
func init() {
	...
	authproviderDescProviderType := authproviderFields[0].Descriptor()
	...
	authproviderDescProviderID := authproviderFields[1].Descriptor()
	...
	authproviderDescCreatedAt := authproviderFields[2].Descriptor()
